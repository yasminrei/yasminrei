...
* 📫 Reach out to me at **dev | at | yasminreina | dot | com**
...
![My Skills](https://skillicons.dev/icons?i=next,react,ts,js,nodejs,postgresql,express,elysia,python,bash,html,css,tailwind,docker,jest,cloudflare,nginx,figma,postman,appwrite,supabase,vercel,netlify,notion,github,githubactions,windows,apple,linux,debian,ubuntu,vite,bun,git,pnpm,npm,svg,markdown,)
